...
<div class="header-edge"><div class="container">Frequestly Asked Questions</div></div>
<!-- end:header -->
		...
		<div class="content col-sm-8 col-md-9">
			...
			<div class="center">
				<ul class="pagination">
					...
					<?php else:?>
					<li><a href="/faq/<?=($pagination->pageNum-1);?>"><span class="fa fa-angle-double-left" aria-hidden="true"></span><span class="sr-only">Previous</span></a></li>
					<?php endif;?>
					...
					<?php else:?>
					<li><a href="/faq/<?=($pagination->pageNum+1)?>"><span class="fa fa-angle-double-right" aria-hidden="true"></span><span class="sr-only">Next</span></a></li>
					<?php endif;?>
				</ul>
			</div><!-- /.center -->
			<?php else:?>
