<div class="main">
	<div class="map-wrapper">
		<div id="map" class="map" data-transparent-marker-image="assets/img/transparent-marker-image.png">
		</div><!-- /.map -->

      <div class="map-filter-horizontal">
        <div class="container">
            <form method="post" action="http://preview.byaviators.com/template/realsite/headers-google-map.html?">
                <div class="row">
