				...
				<form action="/employee/portal/employeeAction" id="updatePasswordForm" method="POST" class="form-horizontal">
					...
					<div class="form">
						<div class="form-body">
							...
							<div class="form-group">
								<div class="col-md-12">
									<textarea name="new_password" placeholder="New Password" class="form-control"></textarea>
									<span class="help-block"></span>
								</div>
							</div> 
							<div class="form-group">
								<div class="col-md-12">
									<textarea name="re_password" placeholder="Repeat Password" class="form-control"></textarea>
									<span class="help-block"></span>
								</div>
							</div> 
						</div>
